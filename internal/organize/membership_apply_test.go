...
func TestPlanMemberships_AddOnly(t *testing.T) {
	...
	edits, err := planMemberships(edited, base, live, boxIDsFor(nil, membershipAnchor), mustInterp(t), membershipDim, "", nil, true)
	if err != nil {
...
func TestPlanMemberships_LastLineVanish(t *testing.T) {
	...
	_, err := planMemberships(edited, base, live, boxIDsFor(nil, membershipAnchor), mustInterp(t), membershipDim, "", nil, true)
	if err == nil {
...
func TestPlanMemberships_NamespaceAdd(t *testing.T) {
	...
	edits, err := planMemberships(edited, base, live, boxIDsFor(nil, membershipAnchor), mustDodderHyphen(t), membershipDim, "project", nil, true)
	if err != nil {
		t.Fatalf("planMemberships: %v", err)
	}
	if len(edits) != 1 {
...
func TestPlanMemberships_AtomDeltasFoldAfterBuckets(t *testing.T) {
	...
	edits, err := planMemberships(edited, base, live, boxIDsFor(nil, membershipAnchor), mustInterp(t), membershipDim, "", deltas, true)
	if err != nil {
		t.Fatalf("planMemberships: %v", err)
	}
...
func TestPlanMemberships_PlacementFoldsOffUsesDeltasOnly(t *testing.T) {
	...
	edits, err := planMemberships(edited, base, live, boxIDsFor(nil, membershipAnchor), mustInterp(t), membershipDim, "", nil, false)
	if err != nil {
		t.Fatalf("planMemberships: %v", err)
	}
	if len(edits) != 0 {
	...
	edits, err = planMemberships(edited, base, live, boxIDsFor(nil, membershipAnchor), mustInterp(t), membershipDim, "", deltas, false)
	if err != nil {
		t.Fatalf("planMemberships: %v", err)
	}
