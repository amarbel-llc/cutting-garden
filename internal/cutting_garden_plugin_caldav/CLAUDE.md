# cutting_garden_plugin_caldav

The CalDAV capture/restore/diff backend for cutting-garden. Peer leaf
of `cutting_garden_plugins/` — not a nested subpackage. Registered in
